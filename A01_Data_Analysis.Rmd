...
Download information on all stocks currently part of the S&P500. Select 10 that have data back to 2000. Additionally download the S&P 500 index and the four Fama-French factors including the risk-free rate. Merge all data together and calculate returns (simple or continuous returns?).
Split your data in two files: One holding daily returns and one with monthly returns. Additionally show how to we could get form long to wide format to transfer between `tibble` (`tsibble`) and xts.
